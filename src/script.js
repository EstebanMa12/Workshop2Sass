...
const featuresDropDown = document.querySelector(".nav__item_features");
const company = document.querySelector("#Company");
const companyDropDown = document.querySelector(".nav__item_company");
...
const hamburgerIcon = document.querySelector(".nav__icon_hamburguer");
const crossIcon = document.querySelector(".nav__icon_close");
const sidebarContainer = document.querySelector(".nav__sidebar_container");
const sidebarMenuFeatures = document.querySelector("#sidebarMenuFeatures");
const sidebarFeaturesDropDown = document.querySelector(".nav__sidebar_features");
const sidebarMenuCompany = document.querySelector("#sidebarMenuCompany");
const sidebarCompanyDropDown = document.querySelector(".nav__sidebar_company");
